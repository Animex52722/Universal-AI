...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "7176089342:AAHRvnVfzOSnKAwUGNyUC-JWwQfpeK5mwpo"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Universal AI
username = 'UniversalAI_bot
